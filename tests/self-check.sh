...
grep -q 'release-manifest.json' "$root/scripts/create-release.sh"
grep -q 'archive_base' "$root/scripts/create-release.sh"
grep -q 'package_base' "$root/scripts/push-images.sh"
